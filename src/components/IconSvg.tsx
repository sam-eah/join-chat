  ...
  if (icon === "chat")
    return (
      <svg viewBox="0 0 20 20" aria-hidden="true" {...props}>
        ...
        <path d="m10 18 -3 -3H5a2 2 0 0 1 -2 -2V5a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-2l-3 3zm-2.172 -5L10 15.172 12.172 13H15V5H5v8h2.828z" />
      </svg>
    );
